 ...
 */
function checkLineWidth(value: nodes.Node, allowsKeywords = true): boolean {
...
function checkLineWidthList(nodes: nodes.Node[], allowsKeywords = true): boolean[] {
 ...
 * @return `true` if this node represents a non-zero border; otherwise, `false`
 */
function checkLineStyle(valueNode: nodes.Node, allowsKeywords = true): boolean {
...
function checkLineStyleList(nodes: nodes.Node[], allowsKeywords = true): boolean[] {
