...
export class Parser {
	...
	public _parseRegexp(regEx: RegExp): nodes.Node {
		const node = this.createNode(nodes.NodeType.Identifier);
	...
	public _parseStylesheetAtStatement(isNested = false): nodes.Node | null {
	...
	public _parseRuleset(isNested = false): nodes.RuleSet | null {
	...
	public _parseExpr(stopOnComma = false): nodes.Expression | null {
